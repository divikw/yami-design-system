...
export const tokens = {
  ...
  "button.tertiary": {
    "$type": "color",
    "$value": "{color.white.0}",
    "$description": "用于弱操作或低干扰按钮，默认背景透明、无描边。"
  },
  ...
  "color.brand.red": {
    "$type": "color",
    "$value": "#ff0000",
    "$description": "品牌锚点色。用于 Logo、Banner 与品牌传播表达，不直接作为通用 UI 主交互色。"
  },
  "color.cyan.100": {
    "$type": "color",
    "$value": "#ccebf5"
  ...
  "font-family.serif": {
    "$type": "fontFamily",
    "$value": {
      "EN": "Source Serif 4 Variable",
      "CN": "Noto Serif SC"
    },
    "$description": "衬线展示字体：英文使用支持 optical sizing 的 Source Serif 4 Variable，中文使用 Noto Serif SC。适用于 display 与 heading-md serif 变体，不用于正文或功能性文字。"
  },
  "font-family.win": {
    "$type": "fontFamily",
    "$value": {
  ...
  "font-weight.semibold": {
    ...
    "$description": "衬线标题字重，适用于 heading-md serif 变体，不用于正文。"
  },
  ...
  "letter-spacing.normal": {
    ...
    "$description": "默认字距，适用于大多数正文、标题与说明场景。无明确需求时优先使用。"
  },
  ...
  "radius.button.emphasis": {
    "$type": "dimension",
    "$value": "{radius.md}",
    "$description": "强操作或次级按钮的默认圆角，用于保持可点击感的同时不过度强调视觉存在感。"
  },
  "radius.button.primary": {
    "$type": "dimension",
    "$value": "{radius.full}",
    "$description": "主按钮或高频操作按钮使用的全圆角样式，用于强化点击引导与品牌识别。"
  },
  "radius.component.default": {
    "$type": "dimension",
    "$value": "{radius.md}",
    "$description": "通用 UI 组件的默认圆角，适用于卡片、弹窗、信息块等基础组件。"
  },
  "radius.component.none": {
    "$type": "dimension",
    "$value": "{radius.none}",
    "$description": "通用组件在需要保持直角样式时使用，常见于表格、列表或强结构化内容。"
  },
  "radius.full": {
    "$type": "dimension",
    "$value": "9999px",
    "$description": "完全圆角。适用于 pill、胶囊标签、头像与圆形元素。"
  },
  "radius.lg": {
    "$type": "dimension",
    "$value": "12px",
    "$description": "中大圆角。适用于卡片、面板与需要更强柔和感的容器。"
  },
  "radius.md": {
    "$type": "dimension",
    "$value": "8px",
    "$description": "默认圆角。适用于按钮、表单控件与常规交互组件。"
  },
  "radius.none": {
    "$type": "dimension",
    "$value": "0",
    "$description": "无圆角。用于直角容器、分割型表面与不需要圆角的结构元素。"
  },
  "radius.sm": {
    "$type": "dimension",
    "$value": "4px",
    "$description": "小圆角。适用于输入框、标签与紧凑型控件。"
  },
  "radius.surface.default": {
    "$type": "dimension",
    "$value": "{radius.lg}",
    "$description": "页面级主要内容区域的默认圆角，用于大块内容容器，确保整体视觉柔和但不过度装饰。"
  },
  "radius.surface.none": {
    "$type": "dimension",
    "$value": "{radius.none}",
    "$description": "页面级或全宽背景使用的直角圆角设置，适用于需要与屏幕边缘对齐的布局区域"
  },
  "radius.tag.primary": {
    "$type": "dimension",
    "$value": "{radius.sm}",
    "$description": "标签、徽标类组件的默认圆角，用于信息标识与状态提示，强调紧凑与轻量感。"
  },
  "radius.xl": {
    "$type": "dimension",
    "$value": "16px",
    "$description": "大圆角。适用于弹窗、抽屉与高层级容器。"
  },
  "space.0": {
    "$type": "dimension",
    "$value": "0",
    "$description": "无间距。用于贴边布局与不需要留白的元素关系。"
  },
  "space.025": {
    "$type": "dimension",
    "$value": "2px",
    "$description": "超小间距。适用于细微分隔、图标与文字的紧贴关系。"
  },
  "space.050": {
    "$type": "dimension",
    "$value": "4px",
    "$description": "小间距。适用于紧凑型组件内部留白与近距离元素间距。"
  },
  "space.100": {
    "$type": "dimension",
    "$value": "8px",
    "$description": "默认紧凑间距。适用于常规组件内边距与基础元素间距。"
  },
  "space.1000": {
    "$type": "dimension",
    "$value": "80px",
    "$description": "页面级超大留白。适用于首屏与大型版块之间的强分隔。"
  },
  "space.150": {
    "$type": "dimension",
    "$value": "12px",
    "$description": "中小间距。适用于表单项、卡片内容与列表内元素间距。"
  },
  "space.200": {
    "$type": "dimension",
    "$value": "16px",
    "$description": "默认间距。适用于常规区块留白与组件间距。"
  },
  "space.250": {
    "$type": "dimension",
    "$value": "20px",
    "$description": "中间距。适用于需要略宽松节奏的组件与内容分组。"
  },
  "space.300": {
    "$type": "dimension",
    "$value": "24px",
    "$description": "中大间距。适用于卡片区块、模块内部与内容分层留白。"
  },
  "space.400": {
    "$type": "dimension",
    "$value": "32px",
    "$description": "大间距。适用于模块级留白与主要分区间距。"
  },
  "space.500": {
    "$type": "dimension",
    "$value": "40px",
    "$description": "较大间距。适用于重点区块之间的留白与布局分隔。"
  },
  "space.600": {
    "$type": "dimension",
    "$value": "48px",
    "$description": "超大间距。适用于大容器留白与页面级分区。"
  },
  "space.800": {
    "$type": "dimension",
    "$value": "64px",
